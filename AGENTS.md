...
4. Do not write Article or `draws_from`. content-media owns that bridge.
5. Actor `grok-bot/research-knowledge-capture`. Ready PR. No force-push.
6. Public samples are Northstar / Lumenfield fiction.
