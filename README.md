...
**Version:** 0.1.0 — Phase 0–3 of the [PRD](docs/prd/research-knowledge-capture-PRD.md).
...
| Host | Ingest | Pack | Validate |
| --- | --- | --- | --- |
| Claude / Grok / Cursor | `/research-ingest` | `/research-pack` | `/research-validate` |
| Codex | `$research-ingest` | `$research-pack` | `$research-validate` |
